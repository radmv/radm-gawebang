        ...
        <section id="header"
            ...
            <div class="flex flex-col gap-5">
                <div class="flex gap-[30px] items-center">
                    ...
                    <span>/</span>
                    <a href="#"
                        class="transition-all duration-300 last-of-type:font-semibold active:font-semibold">Category</a>
                    <span>/</span>
                    <a href="#"
                        class="transition-all duration-300 last-of-type:font-semibold active:font-semibold">{{ $category->name }}</a>
                </div>
