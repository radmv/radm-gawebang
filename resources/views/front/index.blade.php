    ...
    <body class="font-poppins text-[#030303] bg-[#F6F5FA] pb-[100px] px-4 sm:px-0">
        ...
        <section id="header"
            ...
            <h1 class="font-extrabold text-[40px] leading-[45px] text-center sm:text-left">Browse Your <br>Favorites
                Projects</h1>
            <div class="flex flex-col items-center justify-end w-full gap-3 sm:flex-row sm:w-auto">
                <div
                    ...
                    <button class="flex w-9 h-9 shrink-0">
                    ...
                    <a href="{{ route('front.category', $category->slug) }}" class="card">
                        <div
                            ...
                            <div class="flex flex-col gap-[6px]">
                                <p href="" class="text-lg font-semibold">{{ $category->name }}</p>
        ...
        <section id="newest"
            ...
            <div class="flex flex-col w-full gap-4">
                <h2 class="text-xl font-bold">Newest Projects</h2>
                            ...
                            <div class="flex flex-col gap-[10px]">
                                ...
                                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        ...
                                        <p class="text-sm font-semibold">Beginner</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex flex-col sm:w-[300px] h-fit shrink-0 bg-white rounded-[20px] p-5 gap-[30px] sm:mt-[45px]">
                ...
                @auth
                    ...
                    <div class="flex flex-col gap-[10px] rounded-[20px] p-[10px_14px] bg-[#030303]">
                        ...
                        <a href="" class="text-sm font-semibold text-center text-white hover:underline">Top Up
                            Connect</a>
                    </div>
                    <hr>
                @endauth
