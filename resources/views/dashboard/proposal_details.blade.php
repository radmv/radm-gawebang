        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg gap-y-5">
                ...
                @if ($project->has_finished)
                    ...
                    @endif
                @else
                    <span class="w-full p-5 font-bold text-white bg-cyan-500 rounded-2xl">
                        Projek masih dalam pengembangan
                    </span>
                @endif



                <h3 class="text-xl font-bold text-indigo-950">You've applied to this job</h3>
                ...
                <div class="flex flex-row justify-between">
                    <div class="flex flex-row items-center justify-between w-full">
                        <div class="flex flex-row items-center gap-x-4">
                            ...
                            <div class="flex flex-col">
                                <h3 class="text-xl font-bold text-indigo-950">{{ $projectApplicant->freelancer->name }}
                                </h3>
                ...
                <p class="font-medium text-indigo-950 text-md">
                ...
                @if ($projectApplicant->status == 'Hired')
                    ...
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-indigo-950">You're Hired!</h3>
                    ...
                    <hr class="my-5">
                    <h3 class="text-xl font-bold text-indigo-950">Tired of Waiting? Contact Client Now</h3>
                    <div class="flex flex-row items-center px-5 py-3 border gap-x-4 border-slate-200 w-fit rounded-2xl">
                        ...
                        <p class="text-lg font-bold text-indigo-950">{{ $projectApplicant->project->owner->email }}</p>
                    ...
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-indigo-950">Income Rp
                ...
                @elseif ($projectApplicant->status == 'Rejected')
                    ...
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-indigo-950">Sorry, Client Rejected You.</h3>
                            <p class="text-slate-500 text-md">
