<x-app-layout>
    ...
    <x-content-container>
        <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg gap-y-5">
                ...
                <div class="flex flex-row gap-x-5">
                    ...
                    @can('topup wallet')
                        <a href="{{ route('dashboard.wallet.topup') }}"
                            class="px-6 py-4 font-bold text-white bg-green-700 rounded-full">
                            Topup Wallet
                        </a>
                    @endcan
            ...
            <hr class="my-5">
            <h3 class="text-xl font-bold text-indigo-950">Latest Transactions</h3>
            ...
            @forelse ($wallet_transactions as $transaction)
                <div class="flex flex-row items-center justify-between">
                    ...
                    <div class="">
                        ...
                        <h3 class="text-xl font-bold text-indigo-950">{{ $transaction->type }}</h3>
                    </div>
            ...
            @empty
                <p>Belum ada data transaksi terbaru</p>
            @endforelse
