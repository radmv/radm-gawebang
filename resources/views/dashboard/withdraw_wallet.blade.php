    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg gap-y-5">
                <span
                    class="p-5 font-bold text-white {{ Auth::user()->wallet->balance >= 100000 ? 'bg-yellow-600' : 'bg-red-500' }}  rounded-2xl w-fit">
                ...
                <h3 class="text-xl font-bold text-indigo-950">Withdraw Money</h3>
                <form method="POST" action="{{ route('dashboard.wallet.withdraw.store') }}">
                    @csrf

                    <div>
                        <x-input-label for="bank_name" :value="__('bank_name')" />
                        <x-text-input id="bank_name" class="block w-full mt-1" type="text" name="bank_name"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="bank_account_name" class="block w-full mt-1" type="text"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="bank_account_number" class="block w-full mt-1" type="text"
